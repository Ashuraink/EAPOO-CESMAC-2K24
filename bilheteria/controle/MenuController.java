...
public class MenuController {
    ...
    private static void comprarIngresso() {
        ...
        if (escolhaIngressoVIP) {
            ingresso = new IngressosVip(filmeEscolhido, nossosHorarios[escolhaHorario - 1],
                    quantidadeInteira, quantidadeMeia);

            System.out.println("\nResumo da compra para Ingresso VIP:");
            System.out.println("Ingressos VIP para o filme: " + ingresso.getFilme().getNome());
            System.out.println("Sessão: " + ingresso.getHorario());
            System.out.println("Ingressos Inteiros VIP: " + ((IngressosVip) ingresso).getQuantidadeInteira());
            System.out.println("Ingressos Meia-entrada VIP: " + ((IngressosVip) ingresso).getQuantidadeMeia());
        } else {
            ingresso = new IngressoComum(filmeEscolhido, nossosHorarios[escolhaHorario - 1],
                    quantidadeInteira, quantidadeMeia);
